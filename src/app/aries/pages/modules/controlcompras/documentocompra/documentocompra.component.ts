...
import { MdlCompra } from './models/MdlCompra';
import { CompraDocService } from './Services/CompraDoc.service';
...
export default class DocumentocompraComponent implements OnInit {
...
//modelos:
public MdlCompra: MdlCompra = new MdlCompra();
...
constructor(
  ...
  private servicio: CompraDocService
) {}
