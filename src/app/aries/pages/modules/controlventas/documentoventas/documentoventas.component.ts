...
import { ConfirmacionMensaje } from './interfaces/docventas';
import { LstDocVentasService } from './services/LstDocVentas.service';
//angular
...
export default class DocumentoventasComponent implements OnInit {
  ...
  constructor(
    ...
    private servicio: LstDocVentasService,
...
public Nuevo() {
  ...
  this.router.navigate([ `/ControlVentas/Documento/-1`]);
