    ...
    this.route.params.subscribe(params => {
      if (+params['id'] > -1) {
        ...
        this.servicio.Datainfo(+params['id']).subscribe(resp => {
         ...
         this.frmEmpleado.controls['paterno'].setValue(resp.Detalle.paterno);
         this.frmEmpleado.controls['materno'].setValue(resp.Detalle.materno);
         ...
         this.frmEmpleado.controls['id_rh_estatus'].setValue(resp.Detalle.id_estatus.toString());
