...
import { LstDepartamentosService } from './services/LstDepartamentos.service';
import { ConfirmacionMensaje } from './interfaces/departamentos';
//angular
...
export default class DepartamentosComponent implements OnInit  {
...
public Nuevo() {
  ...
  this.router.navigate([ `/ControlRh/Departamento/-1`]);
